...
#         print("build_exchange: ", build_exchange, file=sys.stderr)
...
#                 print(game_teams.my_her.move(my_building.id, self.enemy_buildings[0].id, 1))
#                 print("Отправляем всех на защиту башни", file=sys.stderr)
#
#     def loop(self):
#         while True:
#             try:
